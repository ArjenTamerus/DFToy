  ...
  subroutine precondition(num_pw,num_states,search_direction,trial_wvfn,H_kinetic)
    ...
    do nb=1,num_states
       ...
       do np=1,num_pw
          ...
          temp = temp/(temp+0.5*x**4)

!          temp = 1.0_dp/max(1.0_dp,(x-1.0_dp)) ! 35 iter
!          temp = 1.0_dp/(x+1.0_dp)           ! 27 iter
!          temp = (1.0_dp+x)/(1.0_dp+x+x**2)           ! 26 iter
!          temp = (8.0_dp+4*x)/(8.0_dp+4*x+2*x**2)           ! 21 iter
!          temp = (8.0_dp+4*x + 2*x**2)/(8.0_dp+4*x+2*x**2 + x**3)           ! 22 iter
!          temp = (8.0_dp+4*x + 2*x**2+x**3)/(8.0_dp+4*x+2*x**2 + x**3 + x**4)           ! 22 iter
